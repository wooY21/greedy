...
트리노드 함수를 이용하여 트리 r을 선언하고 임의의 값 n과 값을 저장할 code[]를 선언한다.

부모 노드의 오른쪽 자식의 값이 존재하면 code[n]에 1을 부여하고 오른쪽 자식, 왼쪽 자식을 탐색한다

부모 노드의 왼쪽 자식의 값이 존재하면 code[n]에 0을 부여하고 오른쪽 자식, 왼쪽 자식을 탐색한다

오른쪽 자식과 왼쪽 자식에 더이상 값이 존재하지 않는 NULL값일 때 탐색을 마치고 r->code에 code[n]값을 넣어준다.

이때 허프만 코드가 한번씩 선언 될때마다 n의 값을 1씩 더해준다. n값은 트리의 비트수가 된다.



__* 트리, Huffman_code 함수 구현 - 정보통신공학과_202101650_최우영, 정보통신공학과_201801682_이경호__
__* 압축률 계산 함수 구현 - 정보통신공학과_201801682_이경호, 정보통신공학과_201801724_황주인__
__* Huffman 알고리즘 분석 - 정보통신공학과_202101650_최우영, 정보통신공학과_201801682_이경호, 정보통신공학과_201801724_황주인__ 
